...
export const metadata: Metadata = {
  title: "EffiTech - Автоматизация бизнес-процессов",
  ...
  keywords: "автоматизация бизнеса, индивидуальные системы автоматизации, интеграция ИИ, Telegram-боты, бизнес-процессы, EffiTech",
};
